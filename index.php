		...
		<div class="banner_inner">
			<div class="container">
				<div class="banner_content">
					<h2 class="upper_text">Welcome to College Network</h2>
					<p style="color: black; font-size:20px; font-weight: bold;"> College Network is designed to implement digitalization and reducing work of college staff/faculty like checking assignments and practical submission, providing time-table, solving doubts of students and to overcome the problems caused.

					</p>
					<!-- <a class="primary_btn mr-20" href="login1.php">Donate Food</a>
					<a class="primary_btn yellow_btn text-white" href="login1.php">Request Food</a><br><br>
 -->					<a class="primary_btn mr-20" href="about-us.php">Read More</a>
				</div>
			</div>
		</div>
	</section>
...
<!-- 	<section class="causes_area">
 ...
 -->	<!--================ End Causes Area =================-->
	...
	<!--================ Start About Us Area =================-->
	<!-- <br><section class="about_area section_gap_bottom">
		<div class="container">
			<div class="row">	
				<div class="single_about row">
					...
					<center><div class="col-lg-6 col-md-12 about_right">
						<div class="about_content">
							<h2>
								We are nonprofit team
							</h2>
							 <p>
                                    By redirecting unspoiled food from landfill to our neighbors in need, individuals can support their local communities and reduce environmental impact and also reduce 
                                    scarcity of food for theunaffortable community. Non-perishable and unspoiled perishable food can be donated.
                            </p>
                            <p>
                                        Donated food can also include leftovers from events and surplus food inventory food system.The system determine the fully functional detailed organized system.You can also contribute by taking the volunteery giving your time toward the society.       
                            </p>
		...
		<div class="container">
			...
			<div class="row team_inner">
				<div class="col-lg-3 col-md-6">
					<div class="team_item">
						<div class="team_img">
							<img class="img-fluid" src="img/voluteer/v5.jpg" alt="">
						</div>
						<div class="team_name">
							<h4>Viraj Vaja</h4>
							<p>Manager</p>
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-7">
					...
					<a href="volunteer.php" class="primary_btn yellow_btn rounded">join with us</a>
				</div>
			</div>
		</div>
	</div> -->
